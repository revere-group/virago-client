...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Virago.getInstance().startVirago();
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new CustomGuiMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Virago.getInstance().getName() + " v" + Virago.getInstance().getVersion() + " (@" + Virago.getInstance().getAuthor() + ")");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            if(GuiLicenceKey.isAuthorized) {
                guiScreenIn = new CustomGuiMainMenu();
            } else {
                guiScreenIn = new GuiLicenceKey();
            }
        }
        ...
        if (guiScreenIn instanceof CustomGuiMainMenu)
        {
    ...
    private void runGameLoop() throws IOException
    {
        ...
        this.mcProfiler.startSection("game");
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L)
        {
            ...
            this.debug = String.format("%d fps (%d chunk game%s) T: %s%s%s%s%s", new Object[] {Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.renderChunksUpdated), RenderChunk.renderChunksUpdated != 1 ? "s" : "", (float)this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf(this.gameSettings.limitFramerate), this.gameSettings.enableVsync ? " vsync" : "", this.gameSettings.fancyGraphics ? "" : " fast", this.gameSettings.clouds == 0 ? "" : (this.gameSettings.clouds == 1 ? " fast-clouds" : " fancy-clouds"), OpenGlHelper.useVbo() ? " vbo" : ""});
    ...
    public void updateDisplay()
    {
        if (Minecraft.getMinecraft().thePlayer != null && Minecraft.getMinecraft().currentScreen == null) {
            Virago.getInstance().getServiceManager().getService(ModuleService.class).getModule(MotionBlur.class).createAccumulation();
        }
    ...
    public void dispatchKeypresses()
    {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent())
        {
            ...
            if (down) {
                Virago.getInstance().getEventBus().call(new KeyDownEvent(i));
            } else {
                Virago.getInstance().getEventBus().call(new KeyUpEvent(i));
            }
