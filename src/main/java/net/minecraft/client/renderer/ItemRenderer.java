    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            ...
                            switch (Virago.getInstance().getServiceManager().getService(ModuleService.class).getModule(BlockAnimations.class).animation.getValue()) {
                                case OLD:
                ...
                } else if (Virago.getInstance().getServiceManager().getService(ModuleService.class).getModule(KillAura.class).blocking && this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword) {
                ...
                {
                    switch (Virago.getInstance().getServiceManager().getService(ModuleService.class).getModule(BlockAnimations.class).swing.getValue()) {
                        case NORMAL: {
                        ...
                        case SMOOTH: {
                            this.doItemUsedTransformations(0.0f);
                            this.transformFirstPersonItem(f, f1);
                        }
                    }
                    /*this.doItemUsedTransformations(f1);
