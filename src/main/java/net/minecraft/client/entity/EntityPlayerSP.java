...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        PreMotionEvent event = new PreMotionEvent(this.rotationYaw, this.rotationPitch, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround);
        Virago.getInstance().getEventBus().call(event);
        ...
        Virago.getInstance().getEventBus().call(new PostMotionEvent(this.rotationYaw, this.rotationPitch, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround));
    }
    ...
    /**
     * Moves the entity to the coordinates x, y, z.
     *
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Virago.getInstance().getEventBus().call(eventMove);
