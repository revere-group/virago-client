...
import dev.revere.virago.client.modules.render.Hotbar;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            if (!Virago.getInstance().getServiceManager().getService(ModuleService.class).getModule(Hotbar.class).isEnabled()) {
                this.renderTooltip(scaledresolution, partialTicks);
            }
        }

        Virago.getInstance().getEventBus().call(new Render2DEvent(scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), partialTicks));
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            int k = j1 - j * this.getFontRenderer().FONT_HEIGHT + scoreboardModule.yOffset.getValue();
