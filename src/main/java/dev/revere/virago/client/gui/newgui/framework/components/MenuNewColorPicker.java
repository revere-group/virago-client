...
public class MenuNewColorPicker extends MenuComponent {
    ...
    public void onRender() {
        ...
        for(int h = y; h < y + height; h++) {
            RoundedUtils.round(x + 1, h, width - 1, 1, 12, disabled ? lightenColor(index, 7, color) : darkenColor(index, 7, color));
            index++;
        }
    ...
    public void drawPicker() {
        ...
        DrawImpl.drawRect(renderX + 1, renderY + 1, pickerWindowWidth - 1, pickerWindowHeight - 1, backgroundColor );
