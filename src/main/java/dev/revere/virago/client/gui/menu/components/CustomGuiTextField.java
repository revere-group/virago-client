...
{
    private final FontRenderer fontRendererInstance = Minecraft.getMinecraft().fontRendererObj;
    ...
    public CustomGuiTextField(int componentId, int x, int y, int par5Width, int par6Height, String placeholderText)
    {
        this.id = componentId;
        this.xPosition = x;
        this.yPosition = y;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                RoundedUtils.round(this.xPosition, this.yPosition, this.width, this.height, 3, new Color(221, 221, 221, 150));
                RoundedUtils.outline(this.xPosition, this.yPosition, this.width, this.height, 3, 1, new Color(211, 211, 211, 150));
            }
            ...
            if (Objects.equals(s, "") && !this.isFocused())
            {
                fontService.getRalewaySemiBold14().drawStringWithShadow(placeholderText, (float)l, (float)i1 + 2.5f, 0xA2A2A2);
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = (int) fontService.getRalewaySemiBold14().drawStringWithShadow(s1, (float)l, (float)i1 + 2.5f, i);
            }
            ...
            {
                j1 = (int) fontService.getRalewaySemiBold14().drawStringWithShadow(s.substring(j), (float)j1, (float)i1 + 2.5f, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    fontService.getRalewaySemiBold14().drawStringWithShadow("_", (float)k1, (float)i1 + 2.5f, i);
                }
            }

            if (k != j)
            {
                int l1 = l + fontService.getRalewaySemiBold14().getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + fontService.getRalewaySemiBold14().getHeight());
            }
        }
    }
