...
public class MenuScrollPane extends MenuComponent {
	...
	public void onRender() {
		...
		DrawImpl.drawRect(x, y, width, minOffset * 2, backgroundColor);
		...
		if(newSize > 4) {
			DrawImpl.drawRect(scrollerX, newY + 1, scrollerWidth, newSize - 4, getColor(DrawType.BACKGROUND, scrollerState));
		}
