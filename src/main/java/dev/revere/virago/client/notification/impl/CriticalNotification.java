...
public class CriticalNotification extends Notification {
    ...
    /**
     * Constructs a new critical notification with the given title, message and length.
     *
     * @param title   the title of the notification
     * @param message the message of the notification
     * @param length  the length of the notification
     */
    public CriticalNotification(String title, String message, long length) {
        super(title, message, length, new Color(160, 0, 0));
    }
