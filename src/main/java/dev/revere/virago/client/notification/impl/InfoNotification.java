...
public class InfoNotification extends Notification {
    ...
    /**
     * Constructs a new info notification with the given title, message and length.
     *
     * @param title   the title of the notification
     * @param message the message of the notification
     * @param length  the length of the notification
     */
    public InfoNotification(String title, String message, long length) {
        super(title, message, length, new Color(50, 205, 50));
    }
    ...
    public void show(int amount) {
        ...
        font.getProductSans().drawString(this.getTitle(), x + 4, y + 5, Color.WHITE.getRGB());
