...
public class WarningNotification extends Notification {
    ...
    /**
     * Constructs a new warning notification with the given title, message and length.
     *
     * @param title   the title of the notification
     * @param message the message of the notification
     * @param length  the length of the notification
     */
    public WarningNotification(String title, String message, long length) {
        super(title, message, length, new Color(255, 190, 0));
    }
